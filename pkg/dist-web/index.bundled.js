...
const render$1$1 = (result, container, options) => {
    ...
    const needsScoping = compatibleShadyCSSVersion$1 &&
        container.nodeType === 11 /* Node.DOCUMENT_FRAGMENT_NODE */ &&
        !!container.host && result instanceof TemplateResult$1;
    // Handle first render to a scope specially...
    ...
    if (firstScopeRender) {
        ...
        if (part.value instanceof TemplateInstance$1) {
            prepareTemplateStyles$1(renderContainer, part.value.template, scopeName);
        }
        removeNodes$1(container, container.firstChild);
        container.appendChild(renderContainer);
 ...
 * Marks class as having finished creating properties.
 */
UpdatingElement$1.finalized = true;
...
class SixphereLitElement$1 extends LitElement$1 {
  constructor() {
    super();
    this.updateComplete.then(this.bindChildren.bind(this));
  }
...
class PolarisBarChart extends SixphereLitElement$1 {
  constructor() {
    super();
    this.width = 0;
    this.height = 0;
  ...
  render() {
    return html$1(_templateObject$1(), this.data, this.options, this.width, this.height);
  }
